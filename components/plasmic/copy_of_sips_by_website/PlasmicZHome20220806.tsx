...
import sty from "./PlasmicZHome20220806.module.css"; // plasmic-import: oJlBDk8VAa36sW/css
...
export type PlasmicZHome20220806__VariantMembers = {};

export type PlasmicZHome20220806__VariantsArgs = {};
type VariantPropType = keyof PlasmicZHome20220806__VariantsArgs;
export const PlasmicZHome20220806__VariantProps = new Array<VariantPropType>();

export type PlasmicZHome20220806__ArgsType = {};
type ArgPropType = keyof PlasmicZHome20220806__ArgsType;
export const PlasmicZHome20220806__ArgProps = new Array<ArgPropType>();

export type PlasmicZHome20220806__OverridesType = {
  root?: p.Flex<"div">;
...
export interface DefaultZHome20220806Props {}

function PlasmicZHome20220806__RenderFunc(props: {
  variants: PlasmicZHome20220806__VariantsArgs;
  args: PlasmicZHome20220806__ArgsType;
  overrides: PlasmicZHome20220806__OverridesType;
      ...
      <div className={projectcss.plasmic_page_wrapper}>
        {true ? (
          ...
          >
            ...
            >
              <div className={classNames(projectcss.all, sty.freeBox__lJjvw)}>
                <PageRow
                  className={classNames("__wab_instance", sty.pageRow___8JQmH)}
                >
                  <p.Stack
                    as={"div"}
                    hasGap={true}
                    className={classNames(projectcss.all, sty.freeBox__pdcyx)}
                  >
                    <h2
                      className={classNames(
                        projectcss.all,
            ...
            >
              <PageRow
                className={classNames("__wab_instance", sty.pageRow___3NP9G)}
              >
                <h1
            ...
            {true ? (
              ...
              >
                <PageRow
                  className={classNames("__wab_instance", sty.pageRow__sqDZx)}
                >
                  <p.Stack
                    as={"div"}
                    hasGap={true}
                    className={classNames(projectcss.all, sty.columns__dw0Ju)}
                  >
                    <div
                      className={classNames(projectcss.all, sty.column__gbi3O)}
                    >
                      <SectionMetricsMetric
                        className={classNames(
                          "__wab_instance",
                          sty.sectionMetricsMetric__qnR3X
                        )}
                        slot={
                          <div
                            className={classNames(
                    ...
                    <div
                      className={classNames(projectcss.all, sty.column__mHhxg)}
                    >
                      <Icon3Icon
                        className={classNames(projectcss.all, sty.svg__oM6X)}
                        role={"img"}
                      />
                    </div>

                    <div
                      className={classNames(projectcss.all, sty.column___20YgA)}
                    >
                      <SectionMetricsMetric
                        className={classNames(
                          "__wab_instance",
                          sty.sectionMetricsMetric__wnxRy
                        )}
                        slot={
                          <div
                            className={classNames(
                    ...
                    <div
                      className={classNames(projectcss.all, sty.column___1BGze)}
                    >
                      <Icon3Icon
                        className={classNames(projectcss.all, sty.svg__iwzmh)}
                        role={"img"}
                      />
                    </div>

                    <div
                      className={classNames(projectcss.all, sty.column__mrkkm)}
                    >
                      <SectionMetricsMetric
                        className={classNames(
                          "__wab_instance",
                          sty.sectionMetricsMetric__m2Y0L
                        )}
                        slot={
                          <div
                            className={classNames(
            ...
            >
              <PageRow
                className={classNames("__wab_instance", sty.pageRow__idWok)}
              >
                <ContentOnHover
            ...
            >
              ...
              >
                <p.PlasmicImg
                  ...
                  className={classNames(sty.img__kpt1K)}
            ...
            >
              ...
              >
                <p.PlasmicImg
                  ...
                  className={classNames(sty.img__rtU61)}
                  displayHeight={"100%" as const}
                  displayMaxHeight={"none" as const}
                  displayMaxWidth={"none" as const}
                  displayMinHeight={"0" as const}
            ...
            >
              <PageRow
                className={classNames("__wab_instance", sty.pageRow__ywBBl)}
              >
                <p.Stack
                  as={"div"}
                  hasGap={true}
                  className={classNames(projectcss.all, sty.freeBox__ik0Mz)}
                >
                  <p.PlasmicImg
                    alt={"Cartoon mug of tea decorated with a heart" as const}
                    className={classNames(sty.img___8Gqg)}
                    displayHeight={
                      hasVariant(globalVariants, "screen", "desktop")
                        ? ("130px" as const)
                        : ("100px" as const)
            ...
            >
              <PageRow
                className={classNames("__wab_instance", sty.pageRow__bPAh)}
              >
                {(
                  hasVariant(globalVariants, "screen", "desktop")
                    ? true
                  ...
                  <div
                    className={classNames(projectcss.all, sty.columns__lr53J)}
                  >
                    <div
                      className={classNames(projectcss.all, sty.column___0Pblc)}
                    >
                      {(
                        hasVariant(globalVariants, "screen", "desktop")
                          ? true
            ...
            {true ? (
              ...
              >
                <PageRow
                  className={classNames("__wab_instance", sty.pageRow___1WOkG)}
                >
                  <p.Stack
                    as={"div"}
                    hasGap={true}
                    className={classNames(projectcss.all, sty.columns___2Q7Bs)}
                  >
                    {(
                      hasVariant(globalVariants, "screen", "tabletLandscape")
                        ? true
                    ...
                    {(
                      ...
                      >
                        ...
                        <Icon17Icon
                          className={classNames(projectcss.all, sty.svg__zArky)}
                          role={"img"}
                        />
                      </div>
                    ) : null}
...
type NodeOverridesType<T extends NodeNameType> = Pick<
  PlasmicZHome20220806__OverridesType,
  DescendantsType<T>
>;
type NodeComponentProps<T extends NodeNameType> =
  ...
  } & Omit<PlasmicZHome20220806__VariantsArgs, ReservedPropsType> & // Specify variants directly as props
    // Specify args directly as props
    Omit<PlasmicZHome20220806__ArgsType, ReservedPropsType> &
...
function makeNodeComponent<NodeName extends NodeNameType>(nodeName: NodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicZHome20220806__ArgProps,
          internalVariantPropNames: PlasmicZHome20220806__VariantProps
        }),
      [props, nodeName]
    );

    return PlasmicZHome20220806__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicZHome20220806";
  } else {
    func.displayName = `PlasmicZHome20220806.${nodeName}`;
  }
  return func;
}

export const PlasmicZHome20220806 = Object.assign(
  // Top-level PlasmicZHome20220806 renders the root element
  makeNodeComponent("root"),
  {
    ...
    // Metadata about props expected for PlasmicZHome20220806
    internalVariantProps: PlasmicZHome20220806__VariantProps,
    internalArgProps: PlasmicZHome20220806__ArgProps
  }
);

export default PlasmicZHome20220806;
/* prettier-ignore-end */
