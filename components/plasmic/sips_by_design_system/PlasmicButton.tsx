...
import sty from "./PlasmicButton.module.css"; // plasmic-import: sw7k7LkFBTC/css
...
export type PlasmicButton__VariantsArgs = {
  variant?: SingleChoiceArg<"secondary" | "highlight">;
    ...
    <p.Stack
      ...
      className={classNames(
        ...
        sty.root,
        {
          ...
          [sty.rootshowStartIcon_size_small]:
            hasVariant(variants, "size", "small") &&
            hasVariant(variants, "showStartIcon", "showStartIcon"),
          [sty.rootshowStartIcon_size_small_showEndIcon]:
            hasVariant(variants, "size", "small") &&
            hasVariant(variants, "showStartIcon", "showStartIcon") &&
            hasVariant(variants, "showEndIcon", "showEndIcon"),
          [sty.rootsize_small]: hasVariant(variants, "size", "small"),
          [sty.rootsize_small_showEndIcon]:
            hasVariant(variants, "size", "small") &&
            hasVariant(variants, "showEndIcon", "showEndIcon"),
          [sty.rootvariant_highlight]: hasVariant(
            variants,
            "variant",
            "highlight"
          ),
          [sty.rootvariant_secondary]: hasVariant(
            variants,
            "variant",
            "secondary"
          ),
          [sty.rootvariant_secondary_isDisabled]:
            hasVariant(variants, "variant", "secondary") &&
      ...
      {(
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__hu1N)}
                role={"img"}
              />
            ),
      ...
      >
        {p.renderPlasmicSlot({
          ...
          className: classNames(sty.slotTargetChildren, {
            ...
            [sty.slotTargetChildrenvariant_secondary]: hasVariant(
              variants,
              "variant",
              "secondary"
            )
      ...
      {(hasVariant(variants, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <IconIcon
                className={classNames(projectcss.all, sty.svg___2W9I)}
                role={"img"}
              />
            ),
